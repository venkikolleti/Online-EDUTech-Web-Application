<html>
    ...
    <meta charset="utf-8">
        ...
        <title>Registration details store</title>
    ...
    <div class="container-big-1">
        ...
        <div class="container-big-2 p-5">
            <div class="container text-center pt-5">
                <div class=" bg-danger success text-center col-md-4 col-sm-6 p-3 border border-light m-auto text-light">
                    <b>Registred Unsuccessful</b>
                </div><br>
                <div class="quiz col-md-6 p-5 m-auto mt-5">
                    
                    <h5>Already An Account Is Existed with This Email or RegId. You Can Login Directly. Do YOu wnat to register with another Email and RegiId click on Register.</h5><br>
                    <a href="login.php"><button class="btn btn-primary col-md-3">Login</button></a>
                    <a href="register.php"><button class="btn btn-primary col-md-3 ps-3">Register</button></a>
